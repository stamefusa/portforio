...
- `title`, `description`, `canonical`, OGP, Twitter Card を各ページで出力します
- `/sitemap.xml` と `/robots.txt` を静的生成します
- 記事詳細ページは microCMS のサムネイルを OGP 画像に利用します
- `PUBLIC_GA4_MEASUREMENT_ID` を設定したときだけ GA4 を出力します
